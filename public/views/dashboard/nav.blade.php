          ...
          <li class="nav-item">
           ...
           <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
                ...
                {!! link_to_route('profile.messages', "Wiadomości", null,['class' => 'dropdown-item']) !!}
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              @foreach ($categories as $category)
                {!! link_to_route('category.show', $category->name, ['category' => $category->slug],['class' => 'dropdown-item']) !!}
